...
namespace NoSqlDb
{
  ...
  */
  ...
  {
    out << "\n  ";
    out << std::setw(23) << std::left << "File Name";
    out << std::setw(30) << std::left << "Directory Path";
  ...
  {
    out << "\n  ";
    out << std::setw(15) << std::left << elem.name().substr(0, 8);
    out << std::setw(30) << std::left << elem.payLoad().value().substr(0, 38);
