...
namespace NoSqlDb
{
  ...
  */
  inline void showHeader(bool showKey = true, std::ostream& out = std::cout)
  {
    out << "\n  ";
    if(showKey)
      out << std::setw(26) << std::left << "Key";
    out << std::setw(18) << std::left << "File Name";
	out << std::setw(26) << std::left << "DateTime";
    out << std::setw(15) << std::left << "Author";
  ...
  {
    out << "\n  ";
    out << std::setw(26) << std::left << el.name().substr(0, 26);
	out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(15) << std::left << el.descrip().substr(0, 18);
  ...
  {
    out << "\n  ";
    out << std::setw(26) << std::left << key.substr(0, 26);
    out << std::setw(18) << std::left << el.name().substr(0, 18);
	out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(15) << std::left << el.descrip().substr(0, 18);
    out << std::setw(25) << std::left << std::string(el.payLoad()).substr(0, 18);
    Children children = el.children();
